...
<head>
    ...
    * { padding: 0; margin: 0}
    ...
    .center { position: absolute; left: 50%; margin-left: -120px; height: 100px; top: 50%; margin-top: -100px; background: url(${baseURL}/jsp/wap/images/zhifu.png) no-repeat center top; background-size: 60px 56px; }
    </style>
</head>
