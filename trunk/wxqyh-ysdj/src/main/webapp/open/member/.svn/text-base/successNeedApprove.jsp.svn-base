...
<%@include file="/jsp/common/dqdp_common_open.jsp" %>
    <head>
        ...
        <script src="${resourceURL}/js/do1/common/common.js?ver=<%=jsVer%>"></script>
	...
	<body>
		<div id="wrap_main" class="wrap">
             <div class="submitSucceed yaoqing" id="yaoqing">
                 <div class="head"></div>
                 <div class="wx"><img id="imgUrl" src="" width="158px" /></div>
                 <div class="s">提交成功，请扫码关注</div>
                 <div class="text">长按二维码识别，预先关注该企业微信
                     <div class="red">关注后不需再操作，等待管理员审批通<br>
                    	 过后即可正常使用。
                    	 </div>
                 </div>
                 <%--<div class="foot">
