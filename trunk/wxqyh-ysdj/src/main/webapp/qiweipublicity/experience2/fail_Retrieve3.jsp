...
<%@include file="./header.jsp" %>
    <div class="pwd_box">
        ...
        <div class="pwd_3">
            <img src="images/ic_fail.png" alt="">
            <p class="fRed mt15"><b>${param.userName }</b></p>
            <p class="fRed">重置密码失败了，请返回重试</p>
            <a href="${baseURL}/qiweipublicity/experience2/mail_Retrieve1.jsp" class="pwd_btn btn two_btn mt50">返回重试</a>
        </div>
    </div>
