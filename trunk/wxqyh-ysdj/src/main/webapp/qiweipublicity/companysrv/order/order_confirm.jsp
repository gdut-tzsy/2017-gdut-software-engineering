...
<head>
    ...
    <script src='${baseURL}/themes/qiweipublicity/companysrv/order/order_confirm.js?ver=<%=jsVer%>'></script>
        ...
        <div class="FW_content">
            ...
            <div class="tab-main">
                <form id="orderConfirmForm" action="" method="post" onsubmit="return false;" templateId="default" dqdpCheckPoint="add_form">
                    ...
                    <input type="hidden" value="" id="couponIds" name="couponIds"/>
                    <input type="hidden" value="" id="corpId" name="corpId"/>
                    <input type="hidden" value="" id="priceCode" name="priceCode"/>
                    <input type="hidden" value="" id="buyNum" name="buyNum"/>
