...
<head>
    ...
    <script src='${baseURL}/themes/qiweipublicity/companysrv/vip/vip_person_buy.js?ver=<%=jsVer%>'></script>
        ...
        <div class="FW_content">
            ...
            <div class="tab-main">
                <div class="buyvip-main">
                    <h1 class="buyvip-title" id="buyName">会员人数扩容</h1>
                    <form method="post">
                        <div class="onLine">

                            <div class="item mb40">
                                <span class="dt">人数扩容至：</span>
                                 <span class="dd relative" id="volume">
                                     <span class="positiveIpt">
                                         <input type="button" class="positiveIpt_l p_btn" value="-" />
                                         <input type="text" class="positiveIpt_t" id="vipPerson_member" value="150"/>
                                         <input type="button" class="positiveIpt_r p_btn" value="+" />
                                     </span>
                                      <span class="ml20 c999">人</span>
                                      <span class="ml20 c999">(通讯录人数：<span class="orange" id="userMemberNum">0</span>人，人数上限：<span class="orange" id="vip_max_person">0</span>人)</span>
                                </span>
                                <br/>
                                <div class="check-tips none" id="volumeTips" style="width: 320px;"><span>!</span>购买人数不能为空</div>
                            </div>
                            ...
                            <div class="item mb40">
                                ...
                                <span class="dd" style="position:relative">
                                    ...
                                    <div class="check-tips none" id="corpIdTips" style="width: 400px;"><span>!</span>CorpID不存在</div>
                                </span>
                            </div>
