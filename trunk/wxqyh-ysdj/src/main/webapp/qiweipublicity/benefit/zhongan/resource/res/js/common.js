...
if ("undefined" != typeof BUI) {
    ...
    function(Form, Tooltip, Mask) {
        ...
        $(".za-ins-textbox").live("focus",
        function() {
            $(this).addClass("active");
        });
        $(".za-ins-textbox").live("blur",
        function() {
...
(function() {
	...
	za.src = "//static.zhongan.com/resource/js/ilog.js?d792eb5ed311e5605c562e0f39e100cb";
	var s = document.getElementsByTagName("script")[0]; 
...
function zamenuInit(){
	...
	if($(".m-nav-list").length > 0 && $("#zamenukey").length > 0){
		...
		switch(key){
			...
			case "service": index=7;break; //保险服务
			case "invest": index=8;break; //众赢宝
		}
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data) {
                	...
                	$loginObj.html('请<a href="/open/member/login" class="g-mar-lr5 s-lk" rel="nofollow">登录</a>或者<a href="/open/member/register" class="g-mar-lr5 s-lk" rel="nofollow">免费注册</a>');
    	...
    	$.ajax({
    		...
    		success: function(data) {
                ...
                if (data) {
                	...
                	$loginObj.html('请<a href="/open/eportal/login" class="g-mar-lr5 s-lk">登录</a>或者<a href="/open/eportal/register" class="g-mar-lr5 s-lk">免费注册</a>');
                }
            }
    	});
    }
...
function loginOut() {
    $.ajax({
        ...
        success: function(data) {
            ...
            $loginObj.html('请<a href="/open/member/login" class="g-mar-lr5 s-lk">登录</a>或者<a href="/open/member/register" class="g-mar-lr5 s-lk">免费注册</a>');
            //$loginObj.html('<span><a href="/open/member/login">登录</a><span class="g-mar-lr5">|</span><a href="/open/member/register">注册</a></span>');
        }
    });
}
...
function zatoolbarInit() {
    //两栏界面初始化
    if ($(".za-acc-nav-toolbar").length > 0) {
...
function fnHotInit(){
    ...
    if(o.isser){
	    ...
	    $("#zahotkf").hover(function(){
	    	if(!$(this).is(":animated")){
	    		//$(this).css("backgroundImage",'url("../resource/images/enterprise/ent_qqin_hover.png")');
	    		//$(this).css("backgroundImage",'url("https://www.zhongan.com/resource/images/enterprise/ent_con.png")');
	    		$(this).css("backgroundImage",'url("resource/images/qwzhongan/ent_con.png")');
	    		$(this).animate({"width":"60px"},500);
	    	}
	    },function(){
	    	if($(this).width() > 38){
	        	$(this).animate({"width":"60px"},500,function(){
	            	//$(this).css("backgroundImage",'url("../resource/images/enterprise/ent_qqin_normal.png")');
	        		//$(this).css("backgroundImage",'url("https://www.zhongan.com/resource/images/enterprise/ent_con.png")');
	        		$(this).css("backgroundImage",'url("resource/images/qwzhongan/ent_con.png")');
	        	});
	    	}
...
/* 提示框用弹窗显示 */
function zaMessageShow(text, type, time,btnTxt,btnTxt1) {
    BUI.use('bui/overlay',
    function(Overlay) {
        var dhtml = text;
