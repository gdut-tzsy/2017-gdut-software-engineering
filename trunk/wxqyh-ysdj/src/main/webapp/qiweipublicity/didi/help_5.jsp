	...
	<div class="mainContent">
	    <div class="sideBar fl">
	        <ul>
	            ...
	            <li id="aq_li_5" class="sideActive"><a href="#">支付方式</a></li>
	            <li id="aq_li_6"><a href="#">如何查看订单</a></li>
	            <li id="aq_li_7"><a href="#">如何申请用车发票</a></li>
	        </ul>
	    </div>
	    <div class="rightContent fr">
	        <h3 class="mb10">支付方式</h3>
	        <h5>在行程结束后 , 自动从您所在的企业账户中扣款 , 无须个人垫付费用。支付成功后会发送消息通知给用车员工 , 告之支付金额</h5>
	        <img src="../../themes/manager/companysrv/images/help_5.png" height="586" width="696">
	    </div>
	    <div class="clear"></div>
	</div>
