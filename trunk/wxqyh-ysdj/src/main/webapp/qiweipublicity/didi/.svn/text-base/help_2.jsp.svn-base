	...
	<div class="mainContent">
	    <div class="sideBar fl">
	        <ul>
	            ...
	            <li id="aq_li_2" class="sideActive"><a href="#">如何分配用车权限</a></li>
		...
		<div class="rightContent fr">
	        <h3 class="mb10">如何分配用车权限</h3>
	        <h5>登录管理平台，点击<font class="f-orange">【内容管理】</font>, 点击左边菜单导航的<font class="f-orange">【车辆管理】</font>, 在车辆管理页面点击设置进入设置页面 , 在设置页点击企业叫车权限 , 可设置如下两种权限：</h5>
	        <p>第一种：哪些员工可以打车</p>
	        <p>第二种：每人每月的打车限额</p>
	        <img src="../../themes/manager/companysrv/images/help_2.png" height="653" width="862">
	    </div>
	    <div class="clear"></div>
	</div>
