...
<body>
	...
	<div class="mainContent">
	    <div class="sideBar fl">
	        <ul>
	            <li id="aq_li_1" class="sideActive"><a href="#">如何为企业账户充值</a></li>
	    ...
	    <div class="rightContent fr">
	        <h3 class="mb10">如何为企业账户充值</h3>
	        <h5>登录企微管理平台 , 点击<font class="f-orange">【员工福利】</font>菜单 , 在企业账户中点击充值进入充值页面 , 在充值页面 , 选择线上充值或者线下充值两种方式 , 充值完成后可查看自己的充值记录</h5>
	        <img src="../../themes/manager/companysrv/images/help_1.png" height="976" width="902">
	    </div>
	    <div class="clear"></div>
	</div>
